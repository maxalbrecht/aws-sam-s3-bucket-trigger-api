...
function JobDetails() {
  Logging.LogSectionStart("Inside MpegConversionVeriSuiteJob.JobDetails()")
  Logging.log("this.MpegConversionVeriSuiteJobObject:", this.MpegConversionVeriSuiteJobObject)

  let docs = this.MpegConversionVeriSuiteJobObject.mpegConverter.fileList
  let docsParsed = []
        ...
        <Col style={{paddingLeft:'18px'}}>
          ...
          <Row className="SourceFiles">
            <ListGroup style={{border:'none', paddingLeft:'20px'}}>
              {
                this.MpegConversionVeriSuiteJobObject.mpegConverter.fileList.map(
